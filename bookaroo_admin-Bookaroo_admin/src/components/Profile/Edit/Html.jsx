...
const Html = ({ handleSubmit, form, setForm, ImageUpload }) => {
            ...
            <div className="grid  grid-cols-12 gap-4 mb-5 ">
                        ...
                        <span className="flex flex-wrap justify-center">
                          <div className="relative ">
                            <img alt=""
                              ...
                              className=" thumbnail w-[154px]  h-[154px] rounded-lg shadow-lg border-[2px] border-white object-contain p-2"
                            />
                            <IoCloseOutline
              ...
              <div className="col-span-12  xl:col-span-9 lg:col-span-8">
                <div className="grid grid-cols-12  gap-4 shadow p-6  gap-4 bg-white rounded-[10px]">
                  ...
                  <div className="col-span-12 md:col-span-6">
                    <label className="text-sm mb-2 block">
                      Average price KWH (including Tax) <span className="text-red-600">*</span>
                    </label>
                    <input
                      type="number"
                      className="relative  bg-white w-full rounded-lg h-10  overflow-hidden px-2 border border-[#00000036]  disabled:cursor-not-allowed text-[14px]"
                      value={form?.kwh}
                      onChange={(e) => {
                        setForm({ ...form, kwh: e.target.value })
                      }}
                    />
                  </div>
                </div>
