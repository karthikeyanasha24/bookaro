...
const Html = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      sort: true,
      render: (row) => {
        return <span className="capitalize ellipses" dangerouslySetInnerHTML={{ __html: row?.answer }}></span>
      },
    },
    {
      key: "type",
      ...
      sort: true,
      render: (row) => {
        return <span className="capitalize ellipses" dangerouslySetInnerHTML={{ __html: row?.type }}></span>
      },
    },
    {
      key: "status",
    ...
    <Layout>
      ...
      <div className="shadow-box w-full bg-white rounded-lg mt-6">
        <div className="flex p-4 items-center flex-wrap gap-2">
          ...
          <div className="flex gap-2 ml-auto flex-wrap">
            <SelectDropdown
              ...
              result={(e) => {
                if (e.value === "" && filters.type === "") return
                changeType(e.value);
              }}
              options={[
            ...
            <SelectDropdown
              ...
              result={(e) => {
                if (e.value === "" && filters.status === "") return
        ...
        {!loaging ? (
          <>
            <Table
              className="mb-3 pt-0 p-4  new-set"
