...
import shared, { goalOptions, propTypeOptions } from "./shared";
...
const Html = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.propertyType}</span>;
      },
    },
    {
      key: "city",
      ...
      // sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.city}</span>;
      },
    },
    {
      key: "action",
        ...
        <div className="flex p-4 items-center flex-wrap gap-2">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <SelectDropdown
              ...
              isClearable={false}
              isSingle={false}
              intialValue={filters?.propertyType}
              result={(e) => { handleFilter(e.value, 'propertyType') }}
              options={goalOptions}
            />
