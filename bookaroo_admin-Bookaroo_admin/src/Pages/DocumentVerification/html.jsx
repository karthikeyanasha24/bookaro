      ...
      render: (row) => {
        return (
          <span className="capitalize">
            {row?.documentGrade != "Any" ? "true" : "false"}
          </span>
        );
      },
    },
        ...
        return (
          <>
            <div className="flex items-center justify-start gap-1.5">
              ...
              {
                itm?.documentGrade != "Any" ? <Tooltip placement="top" title="Edit Rating">
                  <a
                    onClick={(e) => edit(itm)}
                    className="border cursor-pointer  hover:opacity-70 rounded-[35px] bg-[#00988e1c] w-10 h-10 !text-primary flex items-center justify-center text-lg text-[#222]"
                  >
                ...
                </Tooltip> : <Tooltip placement="top" title="Add Rating">
                  <a
                    onClick={(e) => add(itm?.id || itm?._id)}
                    className="border cursor-pointer  hover:opacity-70 rounded-[35px] bg-[#00988e1c] w-10 h-10 !text-primary flex items-center justify-center text-lg text-[#222]"
                  >
                    <GoPlusCircle />
                  </a>
        ...
        <div className="flex p-4 items-center flex-wrap gap-2">
          ...
          <div className="flex gap-2 ml-auto">
            <SelectDropdown
              ...
              theme="search"
              isClearable={false}
              intialValue={filters?.isDocumentVerified}
              result={(e) => {
                handleFilters(e.value, "isDocumentVerified");
              }}
              options={DocumentVerification}
            />

            {filters?.isDocumentVerified ? (
              <>
                <button
                  onClick={() => clear()}
              ...
              <DialogPanel className="max-w-md w-full bg-white rounded-[20px]">
                <DialogTitle className="p-6 relative">
                  ...
                  >
                    ...
                    {submited && !document.documentGrade && <span className="text-[#ff0000]">Rating is required</span>}
