          ...
          <>
            <div className="flex items-center justify-start gap-1.5">
              <Tooltip placement="top" title="Admin View">
                <a onClick={() => adminView(itm.id)} className="border cursor-pointer hover:opacity-70 rounded-[35px] bg-purple-100 w-10 h-10 text-purple-700 flex items-center justify-center text-lg">
                  <FaEye />
                </a>
              </Tooltip>
