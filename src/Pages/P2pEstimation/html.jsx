    ...
    const columns = [
        {
            ...
            //   sort: true,
            render: (row) => {
                return <span className="capitalize ">{row?.property?.propertyTitle || "--"}</span>;
            },
        },
        {
            key: "fullName",
            ...
            //   sort: true,
            render: (row) => {
                return <span className="capitalize ">{row?.user?.fullName}</span>;
            },
        },
        {
            key: "city",
            ...
            //   sort: true,
            render: (row) => {
                return <span className="capitalize flex items-baseline gap-1">{row?.property?.city}</span>;
            },
        },
        {
            key: "referencePrice",
            ...
            //   sort: true,
            render: (row) => {
                return <span className="capitalize flex items-baseline gap-1">{row?.property?.referencePrice || 0}</span>;
            },
        },
        {
            key: "createdAt",
