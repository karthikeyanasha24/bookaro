      ...
      ApiClient.get(shared.detailApi, { id }).then((res) => {
        if (res.success) {
          setform({
            ...
            revenueType: res?.data?.revenueType || "",
          });
        }
        loader(false);
      });
          ...
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p class="text-xs lg:text-sm font-normal text-[#75757A]">
                Here you can see all about your {shared.addTitle?.toLowerCase()}
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-12 p-4 gap-4">
              ...
              <div className="lg:col-span-6 col-span-12 flex  mb-5  flex-col ">
                <FormControl
                  ...
                  onChange={(e) => {
                    setform({ ...form, revenueType: e });
                  }}
                  required
                  theme="search"
                  className="border_none"
                />
                {submitted && !form.revenueType && (
