    ...
    <PageLayout>
      <section className="dashboard-page">
        <div className="dashboard-container">
          <div style={{background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px #0001', padding: '32px 24px', marginBottom: 40}}>
            ...
            <div style={{ display: 'flex', gap: 32, background: '#f8f9fb', borderRadius: 16, padding: '32px 24px', justifyContent: 'space-between', flexWrap: 'wrap' }}>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', minWidth: 0 }}>
                ...
                <div>
                  ...
                  <img style={{ width: 80, borderRadius: 8, maxWidth: '100%' }} src="/assets/img/flyer-demo2.jpg" alt="QR flyer demo" />
                </div>
              </div>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', minWidth: 0 }}>
          ...
          <div style={{background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px #0001', padding: '32px 24px'}}>
            <Table
              data={data}
              columns={columns}
              total={data.length}
