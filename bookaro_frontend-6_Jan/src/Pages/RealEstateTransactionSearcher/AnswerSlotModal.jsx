...
export default function AnswerSlotModal({onClose=()=>{},date,result=(_)=>{}}){
    const [activeTab,setActiveTab]=useState("accept")
    const [bookSlot,setBookSlot]=useState((date||null))
    return <>
    <Dialog
                open={true}
                onClose={()=>onClose()}
                        ...
                        <DialogTitle className="p-3">
                            <div className="react-custom">
                                ...
                                <div className="flex border-t p-2 justify-between">
                                    ...
                                    {activeTab === "accept" ? (
                                        <button
                                            onClick={() => result({event:'accept',value:date})}
                                        ...
                                        <button
                                            onClick={() => result({event:'book',value:bookSlot})}
                                            className="bg-[#976DD0] px-4 py-[7px] text-white rounded-full font-[600] text-[14px]"
                                        >
                                            Book
                                        </button>
