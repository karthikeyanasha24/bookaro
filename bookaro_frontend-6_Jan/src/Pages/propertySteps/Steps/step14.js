  ...
  return (
    <>
      ...
      <div className="relative ">
        <PropertyCheck />
        {addrating ? (
          <div className=" lg:overflow-auto lg:h-[720px] h-[100%] overflow-unset lg:p-8 p-4 lg:py-10">
                ...
                <div class="xl:max-w-[500px] w-[100%] mb-3">
                  {/* <input
                    ...
                    onChange={(e) => {
                      ...
                      if (+value > 5) {
                        return setError("Rating value cannot be more than 5");
                      }
                      setError("")
                      if (+value == 0) {
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setError("");
                      if (value === "0" || value === "0.") {
                        return setrat({ ...rat, rating_value: value });
                      }
      ...
      p-2 px-3 h-[44px] md:w-[500px] w-full text-[#5A5A5A]"
                ...
                <div class="xl:max-w-[500px] w-[100%] mb-3">
                  <input
                    ...
                    placeholder={`${ratingName ? "www." + ratingName + ".com" : "Rating URL"
                      }`}
                  />
                </div>
        ...
        {!addrating && (
          <>
            ...
            {msg === `You already have a draft for ${formData?.propertyType} type of property.` ? (
              <SaveDraftModal draftModal={draftModal} setdraftModal={setdraftModal} data={formData} step={12} />
            ) : <></>}
          </>
        )}
      </div>
