...
const SellingForm = () => {
    ...
    const hendleSubmit = (e) => {
        ...
        if (categoryId == "My Project(Home Seeker)" || categoryId == "My Project(Owner Space)") {
            ...
            <section className="py-12 bg-[#ECE4F8] min-h-[60vh]">
                <div className="container mx-auto px-5">
                    <div className="text-center max-w-xl mx-auto">
                        <h1 className="text-xl font-semibold">Want to sell?</h1>
                        <h2 className="text-xl font-medium ">Let a pro do it for you</h2>
