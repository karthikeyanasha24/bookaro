...
const SearchAlert = () => {
  ...
  const getAlerts = (p = {}) => {
    const params = isGuestMode() ? { guest: "true", ...p } : p;
    loader(true);
    ApiClient.get(shared.get, params)
      .then((res) => {
  ...
  return (
    <PageLayout>
      <section className="pt-6 lg:pt-6 pb-[80px] min-h-screen bg-[#f3f5f9] relative">
        <div className="container px-8 mx-auto xl:px-5 h-full flex flex-col">
          <div className="lg:max-w-[1200px] mx-auto max-w-[100%] w-[100%]">
            <div className="text-center mx-auto max-w-lg mb-8">
              <h4 className="text-[#47525E] mb-0 text-[17px]">
                {t("searchAlert.title")}
              </h4>
              {isGuestMode() && (
                <div className="mt-2">
              ...
              <h2 className="text-[#47525E] font-[600] text-[24px] mt-4 text-center">
