...
const MsgHistory = ({ closeModal, card,i, actions }) => {
                ...
                <div className="mt-2 flex border-b border-[#969FAA] pb-3 relative">
                  ...
                  <div className="ms-4">
                    ...
                    <p className="text-[#47525E] text-[14px]">
                      Member since{" "}
                      {dateFormate(card?.buyerId?.createdAt, "MMMM YYYY")}
                    </p>
                  </div>
                  <div
                                                  ...
                                                  <div className="flex flex-wrap gap-5 mt-4 mb-6">
                                                    {item?.documents?.coOwnership?.map(
                                                      (itm) => {
                                                        return (
                                                          <>
                                                            <BsFiletypePdf className="text-[24px] text-black text-black" />
                                                            <span className="text-black text-[12px]">
                                                              {stringSeprator(
                                                                itm?.originalname,
                                                                30
                                    ...
                                    <div className="bg-[#8F3EAD] rounded-[10px] p-2 max-w-[300px] me-auto ">
                                      ...
                                      {item?.applicationFile && (
                                        <>
                                          {item?.applicationFile?.addressProof
                                            ?.length > 0 && (
                                              <>
                                                <p className="text-white font-bold mt-3 mb-1">
                                                ...
                                                {item?.applicationFile?.identityProof?.map(
                                                  (item) => {
                                                    return (
                                                      <>
                                                        <div className="flex items-center gap-2 mb-4">
                                                          <BsFiletypePdf className="text-[24px] me-3 text-white" />
                                                          <span className="text-white text-[12px]">
                                                            {stringSeprator(
                                                              item?.originalname,
                                                              30
                                      ...
                                      {item?.buyerPrice && (
                                        <>
                                          ...
                                          {item?.buyerPrice?.conditions
                                            ?.length > 0 && (
                                              <div className="flex items-center justify-between mt-3 px-4">
                                                <span className="block text-white font-[600] mb-2">
                                                  ...
                                                  <ul className="space-y-2 ">
                                                    {item?.buyerPrice?.fundingType?.map(
                                                      (funding, index) => (
                                                        <li
                                                          key={index}
                                                          className="text-white font-[500]  py-[1px] rounded-md flex items-center"
                                                        >
                                          ...
                                          {card?.buyerPrice?.bank?.amount > 0 && (
                                            <div className="px-4 mt-3 ">
                                              ...
                                              <ul className="space-y-2 ">
                                                <p className="text-white font-[500]  py-[1px] rounded-md flex items-center">
                                                  Amount:
                                                  {
                                                    card?.buyerPrice?.bank
                                                      ?.amount
                                                  }{" "}
                                                  €
                                                </p>
                                      ...
                                      {item?.buyerPrice && (
                                        <>
                                          {item?.buyerPrice?.documents?.length >
                                            0 && (
                                              <>
