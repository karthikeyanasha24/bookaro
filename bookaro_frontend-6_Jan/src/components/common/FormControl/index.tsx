        ...
        {type == "select" ? (
          ...
          <>
            <div className="flex">
              <input
                type="text"
                className="relative border border-[#00000036] text-[14px] bg-white w-full rounded-lg h-10 flex items-center gap-2 overflow-hidden px-3"
                placeholder={placeholder}
                value={text}
                disabled={disabled}
                autoComplete={autoComplete}
          ...
          <textarea
            name={name}
            className="relative border border-[#00000036] bg-white w-full text-[14px] rounded-lg h-[150px] flex items-center gap-2 overflow-hidden px-3 pt-2"
            required={required}
            placeholder={placeholder}
            value={value || ""}
            maxLength={maxlength}
          ...
          <input
            type={type}
            name={name}
            className={`relative  bg-white w-full rounded-lg h-10 text-[14px] overflow-hidden px-2 border border-[#00000036] ${className}`}
            required={required}
            placeholder={placeholder}
            value={value || ""}
            maxLength={maxlength}
