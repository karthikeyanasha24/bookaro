    ...
    <>
      <div className="dashboard-welcome">
        ...
        <div className="dashboard-display-mode-wrap">
          <div className="dashboard-display-mode-meta">
          ...
          <div className="dashboard-display-mode-actions">
            <button
              type="button"
              className="dashboard-settings-button"
              onClick={() => onOpenSettings && onOpenSettings()}
              aria-label={t("dashboard.settings.open", "Ouvrir les paramètres du dashboard")}
            >
