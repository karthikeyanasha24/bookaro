...
const PastTransactions = () => {
  ...
  const navigateToList = () => {
    ...
    if(!form?.location) return setError(t("pastTransactions.enterLocation"))
    if (form.maxSurface) {
      if (+form.minSurface >= +form.maxSurface) return setError(t("pastTransactions.invalidSurfaceRange"))
    }
    if (form.maxPrice) {
      if (+form.minPrice >= +form.maxPrice) return setError(t("pastTransactions.invalidPriceRange"))
    }
    const query = [];
            ...
            <div className="border border-[#8492A6] rounded-[12px] bg-white p-5  lg:max-w-[1000px] md:max-w-[700px] md:w-[100%] w-[90%] mx-auto sm:absolute lg:-bottom-14 md:-bottom-25 -bottom-66  sm:transform-all sm:left-1/2 sm:-translate-x-1/2 md:mt-0 mt-5  ">
              <div className="flex flex-wrap md:justify-between  items-end md:flex-row flex-col ">
                ...
                <div className="md:w-[26%] lg:w-[22%] w-[100%] md:mb-0 mb-3">
                  <label className="text-[#8492A6] mb-1 block">{t("pastTransactions.surface")}</label>
                ...
                <div className="md:w-[15%] lg:w-[15%] w-[100%] md:mb-0 mb-3">
                  <label className="text-[#8492A6] mb-1 block">{t("pastTransactions.rooms")}</label>
                  <div className="flex items-center bg-[#F0F0F0] rounded-[5px] p-2 px-3 w-full h-[44px]">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (parseInt(value) > 5) {
                          value = "5";
                          setError(t("pastTransactions.maxRooms"));
                        } else {
                          setError("");
                        }
                        setForm({
                ...
                <div className="md:w-[26%] lg:w-[22%] w-[100%] md:mb-0 mb-3">
                  <label className="text-[#8492A6] mb-1 block">{t("forms.price")}</label>
