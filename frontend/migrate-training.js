...
const filePath = path.join(__dirname, 'src/Pages/training/index.jsx');
...
const replacements = [
  { old: 'placeholder="Search training"', new: 'placeholder={t("forms.searchTraining")}' },
];
...
console.log('✅ training/index.jsx migrated');
...
try {
  ...
  console.log('📋 Added 1 key for Training');
} catch (error) {
