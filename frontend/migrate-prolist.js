...
const filePath = path.join(__dirname, 'src/Pages/Prolist/index.js');
...
const replacements = [
  { old: 'placeholder="Search Properties"', new: 'placeholder={t("forms.searchProperties")}' },
];
...
console.log('✅ Prolist/index.js migrated');
...
try {
  ...
  console.log('📋 Added 1 key for Prolist');
} catch (error) {
