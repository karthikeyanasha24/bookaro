...
const Html = ({
  ...
  const columns = [
    {
      key: "oneDayCampaignPrice",
      name: "One Day Campaign Price ",
    //   sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.oneDayCampaignPrice || 0}</span>;
      },
    },
   {
      key: "oneMonthCampaignPrice",
      name: "One month Campaign Price ",
    //   sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.oneMonthCampaignPrice || 0}</span>;
      },
    },
     {
      key: "oneWeekCampaignPrice",
      name: "One Weeek Campaign Price ",
    //   sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.oneWeekCampaignPrice || 0}</span>;
      },
    },
    // {
    //   key: "status",
