import { Dialog, DialogBackdrop, DialogPanel, DialogTitle, TabGroup, TabList, TabPanel, TabPanels } from "@headlessui/react";
  ...
  useEffect(() => {
    if (formData?.Expenses?.length > 0) {
      ...
      const filteredData = (TabIndex === 0)
        ? data
        : data?.filter(item => item?.type === typeMap?.[graphTabs?.[TabIndex]]);
    ...
    <div className=" flex justify-between flex-col h-full relative">
      ...
      {addExpenses ? (
        ...
        <button disabled={!editMode}
          ...
          }} className="rounded-[50px] border border-[#976DD0] p-2 text-[#787878] w-[200px] text-[14px] absolute xl:left-auto xl:right-0 lg:left-0 lg:right-auto top-0 "
        >Add New Expenses
        </button>
      )}
      ...
      {addExpenses ? (<>
          ...
          <div className="md:max-w-[500px] w-[100%]">
            ...
            <div>
              ...
              <p className="text-[#000000] font-[600] mt-3  mb-5">
                ...
                the accuracy of the revenus declared and will never be shared with
                a thirdparty.
              </p>
            </div>
            ...
            <div className="mx-auto block mt-8 pb-8">
              <div className="flex flex-col items-center justify-center">
                ...
                <Link className="text-[#976DD0] font-[600] mt-3"
                  onClick={() => applyExpenses(false)}
                >
                  Save and create new expense
                </Link>
              </div>
            </div>
          </div></>
        ...
        <>
         <div className=" lg:overflow-auto lg:h-[580px] h-[100%] overflow-unset lg:p-8 p-4 lg:py-10">
          ...
          <h4 className="text-[#47525E] text-[24px] font-[600] text-left xl:mb-[50px] lg:mb-[50px] mb-[40px]  md:max-w-[500px] xl:mt-0 mt-16 w-[100%]">
              ...
              <p className="font-[400]  text-[16px] text-[#5A5A5A] mb-7 mt-5  xl:w-[500px] w-[100%]">
                Providing this information will help potential buyer or renters to
                estimate their living budget
              </p>
            </h4>
            {addExpenses ? (
        <button onClick={() => closeModal()} className="absolute right-0 top-0 ml-auto text-[20px] border-[#8492A6] border rounded-[50px] p-2 w-[40px] h-[40px] flex items-center justify-center ">
                ...
                {graphTabs?.length > 1 && (
                  <div className="border border-[#8492A6] rounded-[12px] bg-[#F9F9F9] md:max-w-[500px] w-[100%]">
                    <div className="md:max-w-[500px] w-[100%] bg-[#F9F9F9] p-3 rounded-tl-[12px] rounded-tr-[12px]">
                      <h4 className="text-[#39A097] font-[600] text-[20px] text-center">Living Expenses</h4>
                    </div>
                    <TabGroup defaultIndex={TabIndex} onChange={tabChange}>
                      <TabList className="flex-prop md:max-w-[500px] w-[100%] bg-[#F9F9F9] p-3 justify-center flex">
                      ...
                      <TabPanels className="h-full md:max-w-[500px] w-[100%]">
