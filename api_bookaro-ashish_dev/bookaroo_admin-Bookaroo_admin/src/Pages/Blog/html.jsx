  ...
  const columns = [
    {
     ...
     {
      key: "contentLikeCount",
      name: "Likes",
      // sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.contentLikeCount || 0}</span>;
      },
    },
     {
      key: "contentDislikeCount",
      name: "Dislikes",
      // sort: true,
      render: (row) => {
        return <span className="capitalize">{row?.contentDislikeCount || 0}</span>;
      },
    },
    {
      key: "status",
