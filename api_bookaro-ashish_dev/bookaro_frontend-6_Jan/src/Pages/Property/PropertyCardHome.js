    ...
    return (
        <>
            ...
            <div className="relative ">
                <div onClick={() => navigateToDetail(item)} className='p-3'>
                ...
                {(item?.propertyType === "offmarket" && item?.proposal) && (
                    <div className=" flex items-center mb-3">
                        <div className="bg-[#976DD0] mx-auto py-[6px] ps-2 rounded-xl text-[13px] pe-4 text-white  font-[600] relative">
                            <p>{`#Opento${item?.proposal === "both" ? "" : `${item?.proposal}`}proposals`}</p>
                        </div>
                    </div>
                )}
            </div>
            ...
            {/* <div className="absolute -top-10 z-[6] flex items-start left-[10px]">
                <img src={item?.addedBy_details?.image
                    ? imagePath(item?.addedBy_details?.image)
                    : "assets/img/prop-logo.png"} className="  w-[60px] h-[60px] object-cover border border-[#8492A6] rounded-[10px]" alt="" />
                <p className="text-[#47525E] ms-2 mt-2 text-[14px]">
                    {item?.username}
                </p>
            </div>
                ...
                <div>
                    <ul className="flex items-center justify-center p-3">
                        ...
                        <li className="mx-3">
                            <p
                                onClick={() =>
                                    item?.favourite_details// || item?.like
                                        ? disLiked(item)
                                        : isLiked(item)
                                }
                            >
