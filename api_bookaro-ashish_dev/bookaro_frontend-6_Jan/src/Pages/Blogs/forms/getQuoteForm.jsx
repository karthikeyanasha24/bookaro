    ...
    const hendleSubmit = (e) => {
        ...
        ApiClient.post(url, payload).then(async (res) => {
            if (res.success) {
                ...
                if(categoryId == "My Project(Owner Space)")
                {
                     history(`/project`)
                }
                if (type == "Transaction") {
                    history(`/past-transactions`)
                } else if (type == "Professional Repository") {
                    history(`/real-estate-pros`)
                } else {
                    history(`/building-permit`)
                }
            }
            loader(false);
        });
            ...
            <section className="py-12 bg-[#ECE4F8] min-h-[60vh]">
                <div className="container mx-auto px-5">
                    <div className="text-center max-w-xl mx-auto">
                        <h1 className="text-xl font-semibold">Planning to sell your property?</h1>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="col-span-full">
                                    ...
                                    <DatePicker
                                        ...
                                        placeholderText="When would you like to sell? *"
                                ...
                                <div className="col-span-full blog-select relative">
                                    <GooglePlaceAutoComplete
                                        ...
                                        placeholder="In which city is your property *"
                                        id="address"
                                        required
                                    />
