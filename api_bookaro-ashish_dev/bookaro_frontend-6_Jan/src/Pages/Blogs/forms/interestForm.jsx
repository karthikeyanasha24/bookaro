...
const InterestForm = () => {
    ...
    const addressResult = async (e) => {
        ...
        if (e.setValue) {
            e.setValue(address?.city); // Hypothetical function
        }
    };
            ...
            <section className="py-12 bg-[#ECE4F8] min-h-[60vh]">
                <div className="container mx-auto px-5">
                    <div className="text-center max-w-xl mx-auto ">
                        <h1 className="text-xl font-semibold">Looking for funding?</h1>
                        <h2 className="text-xl font-medium ">Find best rates with our partner</h2>
